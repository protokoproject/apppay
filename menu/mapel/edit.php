                ...
                <div class="box-components mt-4">
                    <form method="post">
                        <div class="group-input mb-3">
                            ...
                            <input type="text" class="form-control" id="nm_mapel" placeholder="Nama Mata Pelajaran" name="nm_mapel" value="<?php echo $data['nm_mapel'] ?>">
                        </div>
                        <div class="group-input mb-3">
                            <label for="deskripsi" class="form-label">Deskripsi</label>
                            <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3" placeholder="Masukkan deskripsi mata pelajaran"><?php echo $data['desk'] ?></textarea>
                        </div>
