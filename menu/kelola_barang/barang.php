                    ...
                    <div class="group-trading-history">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                $sql = mysqli_query(
                                    $koneksi,
                                    "SELECT t_brg.kd_brg, t_brg.nm_brg, t_ktg.nm_ktg, t_kantin.nm_kantin, t_brg.st_brg, t_brg.hrg_jual 
             FROM t_brg 
             JOIN t_ktg ON t_brg.id_ktg = t_ktg.id_ktg 
             JOIN t_kantin ON t_brg.id_kantin = t_kantin.id_kantin"
                                );
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?php echo $hasil['nm_kantin']; ?></td>
                                            <td>
                                                <?php if ($hasil['st_brg'] == '1') { ?>
                                                    <span class="badge bg-success">Aktif</span>
                                                <?php } else { ?>
                                                    <span class="badge bg-secondary">Tidak Aktif</span>
                                                <?php } ?>
                                            </td>
                                            <td><?php echo "Rp. " . number_format($hasil['hrg_jual'], 0, ',', '.') . ",-"; ?></td>
                                            <td>
                                                <a href="edit.php?kd_brg=<?php echo $hasil['kd_brg']; ?>" class="btn btn-warning btn-sm">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <a href="delete.php?kd_brg=<?php echo $hasil['kd_brg']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data?')">
