    ...
    <div id="app-wrap">
        <div class="app-section st1 mt-1 mb-5 bg_white_color">
            ...
            SELECT 
                t_tghbyr.id_tgh,
                t_ktgbyr.nm_ktgb,
                CONCAT(t_ajaran.thn_aw, ' - ', t_ajaran.thn_ak) AS tahun_ajaran,
                t_tghbyr.nom 
            FROM 
                t_tghbyr
            JOIN t_ktgbyr ON t_tghbyr.id_ktgb = t_ktgbyr.id_ktgb
            JOIN t_ajaran ON t_tghbyr.idta = t_ajaran.idta
