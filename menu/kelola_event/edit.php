                ...
                <div class="box-components mt-4">
                    <form method="post">
                        <div class="group-input">
                            ...
                            <input type="text" placeholder="Judul Event" name="title" value="<?php echo htmlspecialchars($event['title']); ?>">
                        </div>
                        <div class="group-input">
                            <label>Tanggal Mulai</label>
                            <input type="date" name="start_date" value="<?php echo htmlspecialchars($event['start_date']); ?>">
                        </div>
                        <div class="group-input">
                            <label>Tanggal Selesai</label>
                            <input type="date" name="end_date" value="<?php echo htmlspecialchars($event['end_date']); ?>">
                        </div>
