...
<body class="bg_surface_color">
    ...
    SELECT t_murid.*, t_kelas.nm_kls, t_ortu.nm_ortu 
    FROM t_murid
    JOIN t_kelas ON t_murid.kls_aktif = t_kelas.id_kls
...
");
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><?php echo $data['nm_ortu']; ?></td> <!-- Menampilkan Nama Orang Tua -->
                                            <td><?php echo $data['nm_kls']; ?></td>
                                            <td><?php echo $data['saldo']; ?></td>
                                            <td>
                                                <a href="edit.php?id=<?php echo $data['id_mrd']; ?>" class="btn btn-warning btn-sm">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <a href="delete.php?id=<?php echo $data['id_mrd']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda Yakin Menghapus Data?')">
