...
$id = $_GET['id'];
$sql = mysqli_query($koneksi, "SELECT * FROM t_ajaran WHERE idta = '$id'");
                        ...
                        <div class="group-input">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="tahun_awal" id="tahun_awal" placeholder="Masukkan Tahun Awal" value="<?php echo $data['thn_aw']; ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="tahunAkhir" class="form-label">Tahun Akhir</label>
                                    <input type="number" name="tahun_akhir" id="tahun_akhir" placeholder="Masukkan Tahun Akhir" value="<?php echo $data['thn_ak']; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="group-input">
                            ...
                            <fieldset class="d-flex align-items-center gap-12">
                                <input class="tf-switch-check" id="switchCheckDefault" type="checkbox" name="sts_ajaran" <?php echo $data['sts_thn'] ? 'checked' : ''; ?>>
