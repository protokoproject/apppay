...
<body>
                    ...
                    <div class="row">
                        <div class="col-6 ">
                            <div class="inner-left">
                                <h5>Saldo:</h5>
                                <h2>Rp. 3.000.000</h2>
                                <button class="btn btn-primary d-flex align-items-center mt-2" style="border-radius: 50px; width: 125px; font-size: 12px; height: 20px;">
    ...
    <div class="mt-5 mb-9">
        <div class="tf-container">
            <div class="tf-title d-flex justify-content-between">
                <h3 class="fw_6">Iklan dan Berita</h3>
                <a href="#" class="primary_color fw_6 btn-repicient">View All<i class="fas fa-arrow-right ms-1"></i></a>
            </div>
    ...
    <div class="bottom-navigation-bar">
        <div class="tf-container">
            <ul class="tf-navigation-bar">
                <li class="active"><a class="fw_6 d-flex justify-content-center align-items-center flex-column" href="home.php"><i class="icon-home2"></i> Home</a> </li>
                <li><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="58_history.html"><i class="icon-history"></i> History</a> </li>
                <li><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="40_qr-code.html"><i class="icon-scan-qr-code"></i> </a> </li>
                <li><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="62_rewards.html"><svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        Rewards</a> </li>
                <li><a class="fw_4 d-flex justify-content-center align-items-center flex-column" href="simas/profil/profil.php"><i class="icon-user-outline"></i> Profil</a> </li>
            </ul>
    ...
    <div class="modal fade" id="modalhome1">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="bottom">
                    <a href="#" class="secondary_color btn-hide-modal" data-bs-dismiss="modal" aria-label="Close">Don’t Allow</a>
                    <a href="#" class="primary_color btn-hide-modal" data-bs-toggle="modal" data-bs-target="#modalhome2" data-bs-dismiss="modal" aria-label="Close"> Allow</a>
                    </a>
                </div>
            </div>
        </div>
