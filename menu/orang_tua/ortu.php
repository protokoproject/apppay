                    ...
                    <div class="group-trading-history">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                include "../../conn/koneksi.php";
                                $no = 1;
                                $sql = mysqli_query($koneksi, "SELECT * FROM t_ortu");
                                $dataCount = mysqli_num_rows($sql); // Mengecek jumlah baris hasil query
                                ...
                                ?>
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            <td><?php echo $data['nm_ortu']; ?></td>
                                            <td>
                                                <a href="edit.php?id=<?php echo $data['id_ortu']; ?>" class="btn btn-warning btn-sm">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <a href="delete.php?id=<?php echo $data['id_ortu']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda Yakin Menghapus Data?')">
                                ...
                                <?php
                                    ...
                                    // Jika tidak ada data, tampilkan pesan "Belum Ada Data"
