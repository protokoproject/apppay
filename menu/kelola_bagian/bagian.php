            ...
            <div class="tf-container">
                ...
                <div class="trading-month">
                    ...
                    <div class="group-trading-history">
                        ...
                        ?>
                            <a class="tf-trading-history p-0" href="edit.php?kd_bgn=<?php echo $data['kd_bgn']; ?>">
                                <div class="container">
                                    <div class="inner-left">
                                        <div class="content">
                                            <h4><?php echo $data['nm_bgn']; ?></h4>
                                        </div>
                                    </div>
                                    <div class="num-val">

                                        <a href="edit.php?kd_bgn=<?php echo $data['kd_bgn']; ?>" style="padding-right: 20px;">
                                            <i class="fa fa-pencil"></i>
                                        </a>

                                        <a href="delete.php?kd_bgn=<?php echo $data['kd_bgn']; ?>" onclick="return confirm('Apakah Anda Yakin Menghapus Data?')">
