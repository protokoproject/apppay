                    ...
                    <div class="group-trading-history">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                include "../../conn/koneksi.php";
                                $no = 1;
                                $sql = mysqli_query($koneksi, "SELECT * FROM t_ktg");

                                // Cek apakah ada data di tabel t_ktg
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit.php?id=<?php echo $hasil['id_ktg']; ?>" class="btn btn-warning btn-sm">
                                                    <i class="fas fa-edit"></i> <!-- Ikon Edit -->
                                                </a>
                                                <a href="delete.php?id=<?php echo $hasil['id_ktg']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data?')">
