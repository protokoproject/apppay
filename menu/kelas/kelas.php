                    ...
                    <div class="group-trading-history">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                $no = 1;
                                // Query untuk menggabungkan t_kelas dengan t_guru dan t_ajaran
                                $sql = mysqli_query($koneksi, "
        SELECT t_kelas.id_kls, t_kelas.nm_kls, t_kelas.wali, t_kelas.idta, 
               t_guru.nm_guru, t_ajaran.thn_aw, t_ajaran.thn_ak
        FROM t_kelas
        LEFT JOIN t_guru ON t_kelas.wali = t_guru.id_guru
        LEFT JOIN t_ajaran ON t_kelas.idta = t_ajaran.idta
    ");

                                // Cek apakah ada data di tabel t_kelas
                                ...
                                ?>
                                        <tr>
                                            <td><?php echo $no++; ?></td>
                                            <td><?php echo $hasil['nm_kls']; ?></td>
                                            <td><?php echo $hasil['nm_guru']; ?></td> <!-- Menampilkan nama wali kelas -->
                                            <td><?php echo $hasil['thn_aw'] . ' - ' . $hasil['thn_ak']; ?></td> <!-- Menampilkan tahun ajaran -->
                                            <td>
                                                <a href="edit.php?id=<?php echo $hasil['id_kls']; ?>" class="btn btn-warning btn-sm">
                                                    <i class="fas fa-edit"></i> <!-- Ikon Edit -->
                                                </a>
                                                <a href="delete.php?id=<?php echo $hasil['id_kls']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data?')">
